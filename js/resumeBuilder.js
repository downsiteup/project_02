...
var projects = {
  'projects': [
      ...
      },
      {
          ...
          "URL": ["http://www.br.de/mediathek/video/index.html"]
      },
      {
          "title": "BR2GO",
          "dates": "08/13 - 04/15",
    ...
    'schools': [
        {
            ...
            "date": "1986",
            "URL": "https://www.realschulebayern.de/index.php?id=224&Schulnr=0765"
        },
        {
            "name": "CDI",
            "location": "Munich",
    ...
    'display': function() {
        for (var i in this.schools) {
            ...
            $(id).append((dataChange(school.name, HTMLschoolName) + dataChange(school.degree, HTMLschoolDegree))
                .replace('#', school.url))
                .append(dataChange(school.date, HTMLschoolDates))
